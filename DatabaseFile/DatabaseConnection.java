...
public class DatabaseConnection {
    ...
    public <T extends PlayerData> ObservableList<T> getPlayerData(String tableName, Class<T> playerClass) throws Exception{
        ...
        while(results.next()){
            T player = playerClass.getConstructor(String.class, String.class, String.class, String.class, String.class, String.class, String.class).newInstance(results.getString("playerName"), results.getString("additionalData1"), results.getString("additionalData2"), results.getString("additionalData3"), results.getString("additionalData4"), results.getString("additionalData5"), results.getString("additionalData6"));
            list.add(player);
        }
        return list;
    }
    ...
    public interface PlayerData{
        public PlayerData(String playerName, String additionalData1, String additionalData2, String additionalData3, String additionalData4, String additionalData5, String additionalData6);
    }
